...
void setup() {
  ...
  Serial.println("\n\n\n");
  Serial.println("==============================================");
  Serial.println("ESP32 TWAI (CAN) Test");
  Serial.println("==============================================");
  Serial.println("Dieser Test verwendet die native TWAI-Bibliothek von Espressif.");
  Serial.println("Er testet die CAN-Kommunikation mit 500 kbps.");
  ...
  Serial.println("\nTWAI-Test gestartet. Sende Testnachrichten...");
}
...
void loop() {
  ...
  if (millis() - lastStatusTime > 5000) {
    ...
    if (receivedMessages == 0) {
      ...
      Serial.println("2. Falsche Baudrate - Der Test verwendet 500 kbps");
