/**
 * ESP32 SN65HVD230 CAN Transceiver Test
 *
 * Dieses Programm testet speziell den SN65HVD230 CAN-Transceiver
 * mit einfachen, wiederholten Nachrichten.
 */
...
void setup() {
  ...
  Serial.println("\n\n\n");
  Serial.println("==============================================");
  Serial.println("ESP32 SN65HVD230 CAN Transceiver Test");
  Serial.println("==============================================");
  Serial.println("Dieses Programm testet speziell den SN65HVD230 CAN-Transceiver");
  Serial.println("mit einfachen, wiederholten Nachrichten.");
  ...
  Serial.println("\nSN65HVD230 Test gestartet. Sende einfache Testnachrichten...");
  Serial.println("Bitte stellen Sie sicher, dass:");
  Serial.println("1. Der SN65HVD230 korrekt mit dem ESP32 verbunden ist");
  Serial.println("2. Der RS-Pin des SN65HVD230 mit GND verbunden ist");
  Serial.println("3. Ein 120-Ohm-Widerstand zwischen CANH und CANL angeschlossen ist");
  Serial.println("4. Der Transceiver mit 3.3V versorgt wird");
}
...
void loop() {
  ...
  if (Serial.available() > 0) {
    ...
    switch (cmd) {
      ...
      case 'r':  // TWAI-Treiber zurücksetzen
        resetTWAI();
        break;
  ...
  // Periodisch einfache Testnachrichten senden (alle 1000ms)
