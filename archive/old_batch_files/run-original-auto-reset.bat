@echo off
echo ESP32 DroneCAN mit originalem Auto-Reset
echo =====================================
...
echo.
echo Dieser Skript kompiliert und lädt den originalen Auto-Reset-Code auf den ESP32.
...
echo.
echo Kompiliere und lade originalen Auto-Reset-Code...
...
echo.
echo Originaler Auto-Reset-Code wurde hochgeladen. Öffne den seriellen Monitor, um die Ergebnisse zu sehen.
echo.
