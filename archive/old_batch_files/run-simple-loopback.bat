@echo off
echo ESP32 Simple TWAI Loopback Test
echo ============================
...
echo.
echo Simple Loopback Test wurde hochgeladen. Öffne den seriellen Monitor, um die Ergebnisse zu sehen.
echo.
