@echo off
echo ESP32 DroneCAN mit adaptivem Auto-Reset (Fehlerbehebung)
echo ================================================
...
echo.
echo Dieser Skript kompiliert und lädt den korrigierten adaptiven Auto-Reset-Code auf den ESP32.
echo.
...
echo.
echo Kompiliere und lade korrigierten adaptiven Auto-Reset-Code...
...
echo.
echo Korrigierter adaptiver Auto-Reset-Code wurde hochgeladen. Öffne den seriellen Monitor, um die Ergebnisse zu sehen.
echo.
