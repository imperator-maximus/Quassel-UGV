@echo off
echo ESP32 Advanced TWAI Loopback Test
echo ===============================
...
echo.
echo Advanced Loopback Test wurde hochgeladen. Öffne den seriellen Monitor, um die Ergebnisse zu sehen.
echo.
