...
RC_SKID_PARAMETERS = {
    ...
    # RC Channel Calibration (ECHTE RC-Werte - KORRIGIERT!)
    'RC1_MIN': 1000,          # Steering minimum (wird automatisch kalibriert)
    'RC1_MAX': 2000,          # Steering maximum (wird automatisch kalibriert)
    'RC1_TRIM': 1500,         # Steering neutral (wird automatisch kalibriert)
    'RC1_DZ': 50,             # Steering deadzone (größer für Stabilität)

    'RC3_MIN': 1000,          # Throttle minimum (wird automatisch kalibriert)
    'RC3_MAX': 2000,          # Throttle maximum (wird automatisch kalibriert)
    'RC3_TRIM': 1500,         # Throttle neutral (wird automatisch kalibriert)
    'RC3_DZ': 50,             # Throttle deadzone (größer für Stabilität)
